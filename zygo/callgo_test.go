...
func init() {
	// The tests below need the demo structs.
	// Unless -demo is given on the command line, these
	// are not registered by default to allow users to
	// plug them into their own code to start with.
	RegisterDemoStructs()
}
